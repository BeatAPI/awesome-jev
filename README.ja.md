...
<p align="center">
  ...
  <a href="#all-projects">全 147 プロジェクト</a> ·
...
<p align="center">掲載基準は 50 stars 以上。JEV が選択・採点・ルーティング・フィルタを担い、実行制御はアプリ側に残る事例です。</p>
...
<p align="center">
  <a href="#browser-computer-use"><strong>ブラウザ・PC 操作 · 14</strong></a> ·
  <a href="#sdk-integrations"><strong>SDK・フレームワーク · 23</strong></a> ·
  <a href="#routing-optimization"><strong>ルーティング · 14</strong></a> ·
  <a href="#open-models"><strong>オープンモデル · 17</strong></a> ·
  <a href="#search-data"><strong>検索・データ · 9</strong></a><br>
  <a href="#safety-review"><strong>安全性・レビュー · 12</strong></a> ·
  <a href="#agent-workflows"><strong>Agent ワークフロー · 11</strong></a> ·
  <a href="#interfaces"><strong>UI・自動化 · 8</strong></a> ·
  <a href="#developer-tools"><strong>開発者ツール · 27</strong></a> ·
