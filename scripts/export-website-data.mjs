...
const catalogueHash = createHash('sha256').update(JSON.stringify(catalogue)).digest('hex');
...
export const JEV_PROJECTS_SOURCE_SHA256 = '${catalogueHash}';
export const JEV_PROJECTS_STAR_FLOOR = 50;
